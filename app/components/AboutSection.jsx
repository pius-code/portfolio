      ...
      <div className="md:grid md:grid-cols-2 gap-8 xl:gap-16 mb-4 rounded-sm">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base md:text-lg">
            I am Pius, a well-educated tech innovator, hardwired for the digital
            frontier. Fueled by my passion for cutting-edge technology, I thrive
            on solving complex problems. My skills blend the rhythm of code with
            my dedication to music, and as a mentor, I break down barriers,
            making knowledge accessible in this fast-evolving cyber-world.
          </p>
